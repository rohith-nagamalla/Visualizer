...
def plot(li,option):
    ...
    plt.subplot(2,1,1)
    plt.ylabel("INPUT")
    plt.plot(display,color='blue',drawstyle='steps-pre',marker='>')
    plt.grid(True)
    if option==1:
        plt.subplot(2,1,2)
        plt.ylabel("Unipolar-NRZ")
        plt.plot(unipolar(li),color='blue',drawstyle='steps-pre',marker='>')
        plt.grid(True)
        plt.show()
    elif option==2:
        plt.subplot(2,1,2)
        ...
        plt.subplot(2,1,2)
        plt.ylabel("P-NRZ-I")
        plt.plot(polar_nrz_i(li),color='blue',drawstyle='steps-pre',marker='>')
        plt.grid(True)
        plt.show()
    elif option==4:
        plt.subplot(2,1,2)
        plt.ylabel("Polar-RZ")
        plt.plot(polar_rz(li),color='blue',drawstyle='steps-pre',marker='>')
        plt.grid(True)
        plt.show()
    elif option==5:
        plt.subplot(2,1,2)
        plt.ylabel("B_Man")
        plt.plot(Biphase_manchester(li),color='blue',drawstyle='steps-pre',marker='>')
        plt.grid(True)
        plt.show()
    elif option==6:
        plt.subplot(2,1,2)
        plt.ylabel("Dif_Man")
        plt.plot(Differential_manchester(li),color='blue',drawstyle='steps-pre',marker='>')
        plt.grid(True)
        plt.show()
    else:
        plt.subplot(2,1,2)
